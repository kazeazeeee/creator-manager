export const THEMES = {
  ...
  light:      { bg:'#f0ebe3', fg:'#5a5248', panel:'#faf6f0', border:'#d4cdc2', red:'#c47d5a', label: 'Odysseus Light' },
...
export const applyTheme = (themeName) => {
  ...
  root.style.setProperty('--text-secondary', isDark ? '#828997' : '#5a5248');
  root.style.setProperty('--text-muted', isDark ? '#5c6370' : '#8e867a');
